...
- `/join <friend>` joins a friend's backend (see
  [Phase 16](../../reference-design/03-step-by-step-implementation/implement-join-friend/index.md)).
...
- A vanilla player invited to a Forge map is blocked unless they install the
  ...
  [Phase 17 — cross-runtime invites](../../reference-design/03-step-by-step-implementation/implement-pending-cross-runtime-invites/index.md)).
