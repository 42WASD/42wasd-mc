...
def load_runbook() -> dict[str, str]:
    ...
    Each runbook file lives under docs/implementation/_runbook/ and carries YAML
    frontmatter: `phase: <reference-design/build/...>` mapping it to a build
    phase. Returns {phase_path: markdown_body}.
    """
...
def main() -> int:
    ...
    print(f"Generated implementation progress: {len(parts)} parts -> {OUT}")
    return 0
